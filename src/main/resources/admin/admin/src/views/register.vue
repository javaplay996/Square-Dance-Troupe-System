<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">广场舞团注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='shetuan'" class="input-group">
			   <div class="label">社团编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shetuanbianhao" class="input" type="text" placeholder="社团编号">
			   </div>
			 </div> -->
			<el-form-item label="社团编号" class="input" v-if="tableName=='shetuan'">
			  <el-input v-model="ruleForm.shetuanbianhao" autocomplete="off" placeholder="社团编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shetuan'" class="input-group">
			...
			<!-- <div v-if="tableName=='shetuan'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.shetuanmingcheng" class="input" type="text" placeholder="社团名称">
			   </div>
			 </div> -->
			<el-form-item label="社团名称" class="input" v-if="tableName=='shetuan'">
			  <el-input v-model="ruleForm.shetuanmingcheng" autocomplete="off" placeholder="社团名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shetuan'" class="input-group">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='shetuan'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='shetuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.shetuanbianhao) && `shetuan` == this.tableName){
        this.$message.error(`社团编号不能为空`);
        return
      }
