<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.wudaoqumu" label="舞蹈曲目" prop="wudaoqumu">
          <file-upload
          tip="点击上传舞蹈曲目"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.wudaoqumu?ruleForm.wudaoqumu:''"
          @change="wudaoqumuUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.wudaoqumu" label="舞蹈曲目" prop="wudaoqumu">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.wudaoqumu)">预览</el-button>
          </el-form-item>
        </div>    
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shipinneirong" label="视频内容" prop="shipinneirong">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.shipinneirong)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huodongtupian = true;
          ...
          if(o=='wudaoqumu'){
            this.ruleForm.wudaoqumu = obj[o];
	    this.ro.wudaoqumu = true;
            continue;
          }
          if(o=='shipinneirong'){
	...
	this.ruleForm.huodongneirong = this.ruleForm.huodongneirong.replace(reg,'../../../springbootzko7z/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.wudaoqumu!=null) {
		this.ruleForm.wudaoqumu = this.ruleForm.wudaoqumu.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    wudaoqumuUploadChange(fileUrls) {
	this.ruleForm.wudaoqumu = fileUrls;
	this.addEditUploadStyleChange()
    },
