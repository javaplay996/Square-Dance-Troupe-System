      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shetuantupian" label="社团图片" prop="shetuantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shetuantupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="舞团类型" prop="wutuanleixing">
          <el-select :disabled="ro.wutuanleixing" v-model="ruleForm.wutuanleixing" placeholder="请选择舞团类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="舞团类型" prop="wutuanleixing">
	      <el-input v-model="ruleForm.wutuanleixing"
                placeholder="舞团类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shetuantupian = true;
          ...
          if(o=='wutuanleixing'){
            this.ruleForm.wutuanleixing = obj[o];
	    this.ro.wutuanleixing = true;
            continue;
          }
          if(o=='fuzeren'){
