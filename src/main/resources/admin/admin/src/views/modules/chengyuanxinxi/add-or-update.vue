<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申请内容" prop="shenqingneirong">
          <el-input v-model="ruleForm.shenqingneirong" 
              placeholder="申请内容" clearable  :readonly="ro.shenqingneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申请内容" prop="shenqingneirong">
              <el-input v-model="ruleForm.shenqingneirong" 
                placeholder="申请内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chengyuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chengyuanxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
